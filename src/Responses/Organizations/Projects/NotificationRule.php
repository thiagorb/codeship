...
class NotificationRule
{
	...
	/** @var ?\Thiagorb\Codeship\Responses\Organizations\Projects\NotificationRuleOption[] */
	protected $options;
	 ...
	 * @param ?string $target
	 * @param ?string $branch
	 * @param ?\Thiagorb\Codeship\Responses\Organizations\Projects\NotificationRuleOption[] $options
	...
	/**
	 * @return ?\Thiagorb\Codeship\Responses\Organizations\Projects\NotificationRuleOption[]
	 */
