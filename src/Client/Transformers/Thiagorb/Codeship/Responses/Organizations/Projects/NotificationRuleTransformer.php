...
{
	protected $objectClass = 'Thiagorb\Codeship\Responses\Organizations\Projects\NotificationRule';
		...
		'options' => [
			...
			'arguments' => [
				[
					...
					'arguments' => [
						[
							'transformer' => 'Thiagorb\Codeship\Client\Transformers\Thiagorb\Codeship\Responses\Organizations\Projects\NotificationRuleOptionTransformer',
						],
					],
				],
			],
